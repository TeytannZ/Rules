                ...
                >
                  ...
                  <div className="flex flex-col items-center text-center space-y-6">
                    <div className="relative">
                      <div 
  className={`w-[140px] h-[140px] rounded-full border-4 shadow-2xl transition-all hover:scale-110 duration-300 flex items-center justify-center text-white text-6xl font-bold ${
    approval.isAdmin ? "border-amber-400 shadow-amber-300 bg-amber-500" : "border-green-400 shadow-green-300 bg-green-500"
  }`}
>
  ✓
</div>
